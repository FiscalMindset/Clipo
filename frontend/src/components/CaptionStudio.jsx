          ...
          <div className="flex gap-1.5 p-1.5 bg-white/5 rounded-xl border border-white/5">
            {['presets', 'adjust', 'animations'].map(tab => (
              <button
                ...
                className={`flex-1 py-2.5 px-4 rounded-lg text-sm font-semibold capitalize transition-all duration-200 ${activeTab === tab
              ...
              <div className="grid grid-cols-2 gap-3">
                {PRESETS.map(preset => (
                  <button
                    ...
                    className={`relative p-0 overflow-hidden rounded-xl border transition-all duration-200 active:scale-95 ${activePreset === preset.id
                      ...
                      {['top-left', 'top', 'top-right', 'left', 'center', 'right', 'bottom-left', 'bottom', 'bottom-right'].map(pos => {
                        ...
                        return (
                          <button
                            ...
                            className={`aspect-square rounded-[6px] border flex items-center justify-center transition-all ${isActive ? 'border-purple-500 bg-purple-500/20' : 'border-white/10 bg-white/5 hover:border-white/30'
                              }`}
                          >
