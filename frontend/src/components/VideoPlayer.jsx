  ...
  return <div className="preview-overlay" onMouseDown={onClose}><section className="preview-workspace" onMouseDown={(event) => event.stopPropagation()}>
    ...
    <div className="preview-layout">
      ...
      <aside className="preview-sidebar">
        <div className="preview-insights"><p>AI clip insights</p><div><article><span>🔥 Hook strength</span><strong>Not available</strong></article><article><span>⭐ AI quality score</span><strong>Not available</strong></article><article><span>🎯 Engagement prediction</span><strong>AI selected</strong></article><article><span>⏱ Clip length</span><strong>{duration(clip.duration)}</strong></article></div></div>
